        ...
        <div class="row">
            <div class="col-lg-6" id="left-1">
                <div class="box-left">
                    ...
                    <router-link to="register"><button class="btn-login">Sign Up Here</button></router-link>
                    <div class="row">
            ...
            <div class="col-lg-6" id="right-1">
                <div class="box-right">
                    <h1>Login</h1>
                    <p>Hey, welcome back to News Today!</p>
                    <div class="box-email">
                        <h1>Email Address :</h1>
                    ...
                    <button class="btn-signup" @click.prevent="login">Login</button>
                    <h6>OR LOGIN WITH</h6>
